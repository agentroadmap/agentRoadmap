...
- Postgres pulse table for post-hoc analysis
...
| Cross-cubic comms | 3/10 | Postgres assumed, not proven |
...
| Postgres states (69-77) | Backend infrastructure for Cubic comms — logical |
