...
3. **Connected** — All cubics communicate via SpacetimeDB
...
```
Agent → Roadmap MCP → SpacetimeDB → Other Cubics
           ↑
      (stdio connection)
```

Each agent connects to SpacetimeDB via Roadmap MCP tools:
