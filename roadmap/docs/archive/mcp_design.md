...
When a new agent (e.g., a "Coder Agent") is spawned in your Postgres, your agentRoadmap platform should send an initial "Discovery Directive."
 ...
 * Registry: All your MCP servers (OpenClaw, Google Search, Filesystem) register their capabilities in a Postgres table called mcp_registry.
