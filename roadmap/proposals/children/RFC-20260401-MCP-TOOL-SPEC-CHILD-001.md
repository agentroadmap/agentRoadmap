---
id: RFC-20260401-MCP-TOOL-SPEC-CHILD-001
display_id: RFC-20260401-MCP-TOOL-SPEC-CHILD-001
proposal_type: TECHNICAL
category: INFRA
domain_id: ENGINE
title: "MCP Tool Specification & Domain Organization"
status: Draft
maturity: 0
summary: "Define the 43 MCP tools organized by domain with schema alignment to shared control-plane entities."
---

# MCP Tool Specification & Domain Organization
...
| Tool | Description | Key Inputs | Writes to |
|------|-------------|-----------|-----------|
| `sync_run` | Trigger a sync from Postgres to filesystem | `proposal_id?` (all if omitted) | Filesystem |
...
Each tool calls a Postgres workflow action. Required workflow actions:
