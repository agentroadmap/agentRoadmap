// @ts-nocheck
// TODO: resolve type errors — @ts-nocheck added 2026-04-01 (ProductBuilder vs RowBuilder mismatch)
// Requires Rust toolchain + `spacetime generate` to regenerate properly.
