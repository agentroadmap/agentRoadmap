...
import { DaemonClient, resolveDaemonUrl } from '../core/infrastructure/daemon-client.ts';
import type { Proposal, ProposalCreateInput, ProposalUpdateInput } from "../types/index.ts";
