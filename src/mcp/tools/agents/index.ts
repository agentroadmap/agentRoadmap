	...
	const heartbeatTool: McpToolHandler = createSimpleValidatedTool(
		{
			...
			description:
				...
				"AC#5: Used for zombie detection (agents without heartbeat for 5+ min are marked offline).",
	...
	const zombieDetectTool: McpToolHandler = createSimpleValidatedTool(
		{
			...
			description:
				"Scan for zombie agents (no heartbeat for 5+ minutes) and mark them offline. " +
