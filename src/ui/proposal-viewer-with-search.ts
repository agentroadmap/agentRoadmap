...
import type { Directive, Proposal, ProposalSearchResult } from "../types/index.ts";
import { collectAvailableLabels } from "../utils/label-filter.ts";
import { hasAnyPrefix } from "../utils/prefix-config.ts";
import { applyProposalFilters, createProposalSearchIndex } from "../utils/proposal-search.ts";
