/**
 * Generic list component that consolidates selectList, multiSelect, and ProposalList functionality
...
export class GenericList<T extends GenericListItem> implements GenericListController<T> {
	...
	public setSelectedIndex(index: number): void {
		...
		if (this.selectedIndex === clamped) {
			// Still emit highlight to ensure host proposal stays synchronized
