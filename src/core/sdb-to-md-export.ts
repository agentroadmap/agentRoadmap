...
const SDB_URL = process.env.SDB_URL || 'http://127.0.0.1:3000';
const DB_ID = process.env.SDB_DB_ID || 'c200929bd0127921065806e4e922c2836007c9a6191f6dca26531e3c67090e3e';
