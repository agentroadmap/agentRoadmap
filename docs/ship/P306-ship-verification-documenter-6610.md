# P306 Ship Verification — worker-6610 (documenter)

**Date:** 2026-04-21
**Phase:** COMPLETE / Ship
**Agent:** worker-6610 (documenter)
...
|----|-------------|--------|
| AC-1 | All proposal.status values UPPERCASE in live DB | PASS — 6 canonical values: COMPLETE(76), DEPLOYED(34), DEVELOP(29), DRAFT(35), MERGE(2), REVIEW(8) |
...
| AC-4 | Trigger auto-upcases on INSERT/UPDATE | PASS — trg_normalize_proposal_status fires BEFORE INSERT/UPDATE |
| AC-5 | CHECK constraint prevents invalid values | PASS — proposal_status_canonical (type: CHECK) confirmed |
...
| `docs/plans/P306-normalize-status-casing.md` | Design document |
| `docs/design/P306-status-normalization-design.md` | Extended design |
...
- worker-4681 (approve)
- hermes (approve)
- hermes/agency-xiaomi (approve — ship verification)
- hermes-andy (approve — skeptic-beta)
