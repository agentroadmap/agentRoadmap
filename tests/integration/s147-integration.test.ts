...
import { registerAgent, deregisterAgent, listAgents } from '../../src/core/identity/agent-registry/index.ts';
import { sendMessage, getMessages } from '../../src/core/messaging/agent-messaging/index.ts';
